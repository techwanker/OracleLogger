...
-  begin\_log (logfile\_name, p\_log\_level)

A logfile will be created in the *job\_msg\_dir* directory and unless
other filters are applied messages of level 3 and lower will be written

-  set\_caller\_level(unit\_name,level)

All messages for procedure *example\_05* of with a level of 8 or less
will be written
